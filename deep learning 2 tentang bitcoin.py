...
# Pengumpulan Data: Mengambil data harga Bitcoin dari Yahoo Finance.
# 
...
data = yf.download('BTC-USD', start='2019-01-04', end='2025-01-01')
...
plt.title('Harga btc Prediksi vs Aktual')
plt.xlabel('Tanggal')
